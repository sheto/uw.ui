	...
	<div>
		<div class="banner">
			<div class="banner-desc">
				<h1>专注中文网站的UI库</h1>
				<p>基于Element-UI 2.13.2，精简为支持中文网站的常用UI组件库</p>
			</div>
		</div>
		<div class="jumbotron" ref="indexMainImg">
			<img src="~web/assets/images/theme-index-blue.png" alt="">
			<div class="jumbotron-red" :style="{height: mainImgOffset + 'px'}">
				<img src="~web/assets/images/theme-index-red.png" alt="">
			</div>
		</div>
		<div class="cards">
			<ul class="container">
				<li>
					<div class="card">
						<img src="~web/assets/images/component.png" alt="">
						<h3>组件</h3>
						<p>使用组件 Demo 快速体验交互细节；使用前端框架封装的代码帮助工程师快速开发。</p>
						<router-link active-class="active" to="/component/layout" exact>查看详情
						</router-link>
					</div>
				</li>
				<li>
					<div class="card">
						<img src="~web/assets/images/resource.png" alt="">
						<h3>资源</h3>
						<p>下载相关资源，用其快速搭建页面原型或高保真视觉稿，提升产品设计效率。</p>
						<router-link active-class="active" to="/resource" exact>查看详情
						</router-link>
					</div>
				</li>
			</ul>
