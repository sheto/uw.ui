...
describe("MessageBox", () => {
	...
	it("create and close", done => {
		...
		setTimeout(() => {
			...
			expect(
				msgbox
					.querySelector(".el-message-box__message")
	...
	it("alert", done => {
		...
		setTimeout(() => {
			...
			expect(
				document.querySelector(".el-message-box__wrapper").__vue__
					.$parent.visible
			).to.true;
			expect(
				document.querySelector(".el-message-box__wrapper").__vue__
	...
	it("prompt", done => {
		...
		setTimeout(() => {
			...
			expect(messageBox.$el.querySelector(".el-message-box__input")).to
				.exist;
			...
			setTimeout(() => {
				expect(
					messageBox.$el.querySelector(".el-message-box__errormsg")
						.textContent
	...
	describe("custom validator", () => {
		it("returns a string", done => {
			...
			setTimeout(() => {
				...
				setTimeout(() => {
					expect(
						document.querySelector(".el-message-box__errormsg")
							.textContent
					).to.equal("wrong");
	...
	describe("promise", () => {
		...
		it("reject", done => {
			...
			setTimeout(() => {
				document
					.querySelector(".el-message-box__wrapper .el-button")
					.click();
			}, 50);
		});
	});
